...
MANIFEST: list[Feature] = [
    ...
    Feature(
        ...
        unit="pts",
        description="Change in cash share between the baseline snapshot and the current one.",
        rubric="capacity",
    ...
    Feature(
        ...
        unit="count",
        description="Number of withdrawal transactions in the history across all portfolios.",
        rubric="capacity",
    ...
    Feature(
        ...
        label="Withdrawals YTD",
        unit="% AUM",
        description="Sum of withdrawals in the history as a share of current household AUM.",
        rubric="capacity",
    ...
    Feature(
        ...
        unit="% p.a.",
        description="Dividends, coupons, interest and distributions received in the transaction history, annualised, as a share of AUM.",
        rubric="capacity",
    ...
    Feature(
        name="ltv_change_2_snapshots_pts",
        label="LTV change over two snapshots",
        unit="pts",
        description="Current LTV minus LTV two snapshots earlier for the tightest facility.",
        rubric="capacity",
    ...
    Feature(
        ...
        unit="% AUM",
        description="Value of increases in equity, structured-product, commodity and alternative positions during stress windows (snapshot intervals where equity indices fell or volatility spiked), inferred from position changes.",
        rubric="appetite",
    ...
    Feature(
        ...
        unit="%",
        description="Largest peak-to-trough fall in household USD value across the snapshots. Includes flows, so read alongside withdrawals.",
        rubric="appetite",
    ...
    Feature(
        ...
        unit="%",
        description="Household USD value at the current snapshot versus the baseline. Includes flows.",
        rubric="context",
